import {LEVEL_1, LEVEL_2, LEVEL_3, LEVEL_4, LEVEL_5, LEVEL_6, LEVEL_7, LevelsEntities} from "./LevelsEntities";
...
export const levelTemplates: IRoutes[] = [
  {entities: LEVEL_1, maxMoves: 82, levelNumber: 1},
  {entities: LEVEL_2, maxMoves: 100, levelNumber: 2},
